      ...
      <div className="mx-auto flex min-h-[80vh] w-full max-w-xl items-center">
        <div className="w-full rounded-3xl bg-white p-6 text-center shadow-sm">
          ...
          <p className="mt-3 text-slate-600">
            Vielen Dank. Die Werkstatt wurde über Ihre Freigabe informiert und
            kann die Zusatzarbeit nun durchführen.
          </p>
          ...
          <p className="mt-5 text-xs leading-5 text-slate-500">
            Diese Demo zeigt später den Abschluss des Freigabeprozesses. In der
            echten App wird hier zusätzlich ein Zeitstempel gespeichert.
          </p>
