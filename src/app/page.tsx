        ...
        <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-6 max-w-4xl text-4xl font-bold tracking-tight sm:text-6xl">
              Zusatzarbeiten und Fahrzeugzustand einfach per Fotolink
              dokumentieren.
            </h1>

            <p className="mt-8 max-w-2xl text-lg leading-8 text-slate-200">
              {APP_TAGLINE} Für freie Kfz-Werkstätten: Fotos aufnehmen,
              Fahrzeugannahme dokumentieren, Kundenfreigaben einholen und später
              alles als Nachweis sichern.
            </p>
            ...
            <p className="mt-5 text-sm text-slate-500">
              Für Werkstatt-Tests, Annahmeprotokolle und digitale
              Kundenfreigaben.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
            ...
            <div className="mt-5 space-y-4">
              ...
              <div className="rounded-2xl bg-slate-900 p-4">
                ...
                <p className="mt-1 text-sm leading-6 text-slate-400">
                  Fahrzeugannahme, Schäden oder Zusatzarbeiten mit Fotos
                  festhalten.
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-slate-900 p-4">
                ...
                <p className="mt-1 text-sm leading-6 text-slate-400">
                  Kunde prüft den Link und gibt frei oder stellt eine Rückfrage.
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-slate-900 p-4">
                ...
                <p className="mt-1 text-sm leading-6 text-slate-400">
                  Status, Fotos und Freigabe bleiben im Auftrag nachvollziehbar.
                </p>
              </div>
            </div>
          </div>
